...
// import { VideoGameResponse } from "../types/index";
// import { updateVideoGame } from "../actions/videoGameActions";
...
// export default function UpdateGameForm({ onClose, game }: { onClose: (state: boolean) => void, game: VideoGameResponse }) {
//     const queryClient = useQueryClient();
//     const { register, handleSubmit, formState: { errors } } = useForm<VideoGameResponse>({
//         defaultValues: game
//     });
//     const mutation = useMutation(updateVideoGame);
//     const mutationDelete = useMutation(() => {
//         return axios.delete(`https://localhost:7008/api/VideoGame/${game.id}`);
//     });

//     const onSubmit: SubmitHandler<VideoGameResponse> = (data) => {
